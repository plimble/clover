...
// DeleteAccessToken provides a mock function with given fields: _a0
func (_m *TokenStorage) DeleteAccessToken(_a0 string) error {
	ret := _m.Called(_a0)
...
func (_m *TokenStorage) DeleteRefreshToken(_a0 string) error {
	ret := _m.Called(_a0)
...
func (_m *TokenStorage) GetAccessToken(_a0 string) (*clover.AccessToken, error) {
	ret := _m.Called(_a0)
...
// GetRefreshToken provides a mock function with given fields: _a0
func (_m *TokenStorage) GetRefreshToken(_a0 string) (*clover.RefreshToken, error) {
	ret := _m.Called(_a0)
